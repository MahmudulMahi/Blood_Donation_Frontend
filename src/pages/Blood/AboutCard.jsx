...
const AboutCard = ({card}) => {
  ...
  return (
    ...
    <div className=" md:w-full w-[300px] flex justify-center mt-12 space-x-2 hover:-translate-y-5 hover:shadow-md hover:shadow-brandPrimary rounded-xl  hover:rounded-xl transition-all duration-300 m-10 border">

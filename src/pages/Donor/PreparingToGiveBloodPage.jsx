...
const PreparingToGiveBloodPage = () => {
  return (
    <div className='lg:mx-28 '>
      ...
      {/* ------------- */}
      <div className="mt-12 rounded-lg  bg-[#FFF]  w-full lg:h-[350px] md:h-[390px] h-[800px] relative p-1 " style={{

        boxShadow: "rgba(0, 0, 0, 0.25) 0px 4px 4px 0px"
      }}>
        <div>
          <h2>   <button className="bg-[#e11b221a] w-[230px] md:w-[370px] text-black lg:px-6 md:px-4 px-6 lg:py-4 md:py-2 py-4 rounded-md ml-2 mt-4 lg:mt-2 md:mt-2  font-bold shadow-md text-left mb-10 md:mb-0 absolute -top-10 text-2xl">
            Welcome and preparation
          </button></h2>
        </div>

        <div className="absolute md:top-4 top-10 ml-2 p-2 md:p-10">
          <p className='mt-7 md:mt-0'> <span className='mb-3 block' > Before donating blood, please eat regular meals, drink plenty of fluid (non-alcoholic) and avoid vigorous exercise or exertion.</span>
      ...
      {/* ------------- */}
      <div className="mt-12 rounded-lg  bg-[#FFF]  w-full lg:h-[550px] md:h-[700px] h-[1360px] relative p-1 " style={{
        ...
        <div className="absolute md:top-4 top-10 ml-2 p-2 md:p-10">
          <p className='mt-7 md:mt-0'> <span className='mb-3 block' > You will be called for private health screening, where a donor carer will confirm your identity. It’s critical that we guarantee an accurate link between you, your Donor Safety Check and your donation.</span>
      ...
      <div className="mt-12 rounded-lg  bg-[#FFF]  w-full lg:h-[770px] md:h-[930px] h-[1800px] relative p-1 " style={{
        ...
        <div className="absolute md:top-4 top-10 ml-2 p-2 md:p-10">
          <p className='mt-7 md:mt-0'> <span className='mb-3 block' > When you are comfortable on the chair, you will be asked your name, address and date of birth again.</span>
      ...
      <div className="mt-12 rounded-lg  bg-[#FFF] lg:h-[150px] md:h-[150px] h-[300px]  w-full  relative p-1 " style={{
        ...
        <div className="absolute md:top-4  top-10 ml-2 p-2 md:p-10 ">
          <p className='mt-7 md:mt-0 '> <span className='mb-3 block' >If you become unwell (other than a cold or cold-sore) within 2 weeks following your donation, or if you believe there is a reason your blood should not be given to a patient, please call our donor helpline on 0300 123 23 23.</span>
      ...
      <div className="mt-12 rounded-lg  bg-[#FFF]  w-full lg:h-[150px] md:h-[200px] h-[320px] relative p-1 " style={{
        ...
        <div className="absolute md:top-4 top-10 ml-2 p-2 md:p-10">
          <p className='mt-7 md:mt-0 '> <span className='mb-3 block' >During a blood donation we take 470ml of blood, which is just under a pint.</span>
            <span className='mb-3 block' >
      ...
      <div className="mt-12 rounded-lg  bg-[#FFF]  w-full lg:h-[280px] md:h-[380px] h-[620px] relative p-1 " style={{

        boxShadow: "rgba(0, 0, 0, 0.25) 0px 4px 4px 0px"
      }}>
        <div>
          <h2>   <button className="bg-[#e11b221a] w-[300px] md:w-[450px] text-black lg:px-6 md:px-4 px-6 lg:py-4 md:py-2 py-4 rounded-md ml-2 mt-4 lg:mt-2 md:mt-2  font-bold shadow-md text-left mb-10 md:mb-0 absolute -top-10 text-2xl">
            What to do after donating blood?
          </button></h2>
        </div>

        <div className="absolute md:top-4  top-10 ml-2 p-2 md:p-10">
          <p className='mt-9 md:mt-0 '> <span className='mb-3 block' >To help you stay well after you have given blood, we advise you to:</span>
      ...
      <div className="mt-12 rounded-lg  bg-[#FFF]  w-full lg:h-[300px] md:h-[400px] h-[620px] relative p-1 " style={{

        boxShadow: "rgba(0, 0, 0, 0.25) 0px 4px 4px 0px"
      }}>
        <div>
          <h2>   <button className="bg-[#e11b221a] w-[300px] md:w-[500px] text-black lg:px-6 md:px-4 px-6 lg:py-4 md:py-2 py-4 rounded-md ml-2 mt-4 lg:mt-2 md:mt-2  font-bold shadow-md text-left mb-10 md:mb-0 absolute -top-10 text-2xl">
            Feeling unwell after giving blood
          </button></h2>
        </div>

        <div className="absolute md:top-4 top-10 ml-2 p-2 md:p-10">
          <p className='mt-9 md:mt-0 '> <span className='mb-3 block' > If you Feel faint (light headed or dizzy, hot, sweating, trembling, shaky or nauseous) lie down immediately, rest until you feel better and drink plenty of fluid.</span>
